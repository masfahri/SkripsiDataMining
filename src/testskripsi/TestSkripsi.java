...
public class TestSkripsi {
    ...
    public static void main(String[] args) throws TwitterException {
        ...
        Query query = new Query("Rocky Gerung");
        QueryResult result = twitter.search(query);

//Get Tweets        
        for(Status st : result.getTweets()) {
            System.out.println(st.getUser().getName()+" ======== "+st.getText()+"\n");
            System.out.println(st.getUser().getCreatedAt()+" Tanggal Tweet: "+st.getCreatedAt()+"\n");
            System.out.println(st.getUser().getLocation()+" Location Tweet: "+st.getPlace()+"\n");
            System.out.println("================================");
        }
    }
}
